package com.console_project.storage;
 ...
 */
public class InMemoryStorage implements Storage<City> {
     ...
     */
    public InMemoryStorage(List<City> initCollection) {
        idSet = new HashSet<>();
    ...
    @Override
    public void addElement(City city) throws TooMuchElementsException {
